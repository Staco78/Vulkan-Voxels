...
impl Buffer {
    ...
    pub unsafe fn fill(&mut self, device: &Device, data: &[u8]) -> Result<()> {
        ...
        let memory_ranges = &[vk::MappedMemoryRange::builder().memory(self.memory).offset(0).size(vk::WHOLE_SIZE as u64)];
